const startingMessages = [
  ...
  (personA, personB, teamA, teamB) =>
    `The USA hasnt seen anything like ${teamA} Vs ${teamB}, <@${personA}> Vs <@${personB}>.`,
];
...
const middleMessageWinner = [
  ...
  (
    ...
    `I believe, i believe i believe that ${winningTeam} can win!\n${winningTeam}: ${winningScore} - ${losingTeam}: ${losingScore}`,
  (
    winningPerson,
    losingPerson,
    winningTeam,
  ...
  (
    ...
    `I think <@${winningPerson}> can keep the lead. Come on ${winningTeam}.\n${winningTeam}: ${winningScore} - ${losingTeam}: ${losingScore}`,
  (
    winningPerson,
    losingPerson,
    winningTeam,
    ...
    `<@${winningPerson}> is getting a bit nervous now.\n${winningTeam}: ${winningScore} - ${losingTeam}: ${losingScore}`,
  (
    winningPerson,
    losingPerson,
    winningTeam,
    ...
    `Walk in the park for ${winningTeam}.\n${winningTeam}: ${winningScore} - ${losingTeam}: ${losingScore}`,
  (
    winningPerson,
    losingPerson,
    winningTeam,
    ...
    `Stop trying to walk it in ${losingTeam}.\n${winningTeam}: ${winningScore} - ${losingTeam}: ${losingScore}`,
  (
    winningPerson,
    losingPerson,
    winningTeam,
  ...
  (
    ...
    `Get VAR on that one, i think <@${losingPerson}> should be ahead.\n${winningTeam}: ${winningScore} - ${losingTeam}: ${losingScore}`,
  (
    winningPerson,
    losingPerson,
    winningTeam,
...
const nilnilMiddle = [
  ...
  (personA, personB, teamA, teamB) =>
    `Tax returns are more fun than this. \nAll equal with <@${personA}> and <@${personB}>.`,
  (personA, personB, teamA, teamB) =>
    `Reckon you can break the deadlock <@${personA}>?`,
  (personA, personB, teamA, teamB) =>
    `Niether <@${personA}> nor <@${personB}> is closer to the jackpot at this point`,
  (personA, personB, teamA, teamB) =>
    `Is this a good game? I'm not actually programmed to know. Let me know <@${personA}>.`,
  (personA, personB, teamA, teamB) => `Couldnt score in a brothel`,
  (personA, personB, teamA, teamB) => `Do something.`,
];
const finalNilnilMiddle = [
  (personA, personB, teamA, teamB) =>
    `Really, you are doing this in the final?. Not even 1 goal?`,
];
...
const endMessage = [
  ...
  (
    ...
    `May as well rip up that tenner now <@${losingPerson}>.\n${winningTeam}: ${winningScore} - ${losingTeam}: ${losingScore}`,
  (
    winningPerson,
    losingPerson,
    winningTeam,
  ...
  //   losingScore,
  // ) =>
  //   `<@${winningPerson}> better practice their German, ${winningTeam} are heading for the final.\n${winningTeam}: ${winningScore} - ${losingTeam}: ${losingScore}`,
];
...
const endMessageDraw = [
  (personA, personB, teamA, teamB) =>
    `This would never happen at the world cup. Its all equal with <@${personA}> and <@${personB}>.`,
  (personA, personB, teamA, teamB) =>
    `More time im not getting back. <@${personA}> and <@${personB}> couldn't find a winner.`,
  (personA, personB, teamA, teamB) =>
    `You would have thought id have better messages for a draw by now. You're wrong. Neither <@${personA}> or <@${personB}> could get ahead.`,
];
...
const personAisB = [
  ...
  (person, teamA, teamB) =>
    `I think <@${person}> is a bit lonely, playing with ${teamA} and ${teamB}.`,
];
