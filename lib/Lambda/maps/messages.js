const startingMessages = [
  ...
  (personA, personB, teamA, teamB) =>
    `Germany hasnt seen anything like ${teamA} Vs ${teamB}, <@${personA}> Vs <@${personB}>.`,
];
...
const middleMessageWinner = [
  ...
  (
    ...
    `I think <@${winningPerson}> can take the lead. Come on ${winningTeam}.\n${winningTeam}: ${winningScore} - ${losingTeam}: ${losingScore}`,
  (
    winningPerson,
    losingPerson,
    winningTeam,
...
const endMessage = [
  ...
  (
    ...
    `<@${losingPerson}> heading the same way as Rishi.\n${winningTeam}: ${winningScore} - ${losingTeam}: ${losingScore}`,
  (
    winningPerson,
    losingPerson,
    winningTeam,
